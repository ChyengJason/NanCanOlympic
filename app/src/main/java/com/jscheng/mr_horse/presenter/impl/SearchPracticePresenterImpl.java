 ...
 */
public class SearchPracticePresenterImpl implements PracticePresenter {
    ...
    public SearchPracticePresenterImpl(Context context,Intent intent){
    ...
    private void initStoreData() {
        ...
        loadSubscription = Observable.create(new Observable.OnSubscribe<List<QuestionModel>>() {
            ...
            public void call(Subscriber<? super List<QuestionModel>> subscriber) {
                 temQuestionList = QuestionModelLoadUtil.getQuestionModelsfromDB(mContext,catogory);
