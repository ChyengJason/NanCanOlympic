...
public class AnswerListViewAdapter extends BaseAdapter {
    ...
    public int getChooseDrawable(int position){
        switch (position) {
            case 0:return R.mipmap.practise_a_n_day;
            case 1:return R.mipmap.practise_b_n_day;
            case 2:return R.mipmap.practise_c_n_day;
            case 3:return R.mipmap.practise_d_n_day;
            case 4:return R.mipmap.practise_e_n_day;
            case 5:return R.mipmap.practise_f_n_day;
            case 6:return R.mipmap.practise_g_n_day;
        }
        return 0;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.answerText.setText(mQuestionModel.getOptionList().get(position));
        return convertView;
    }
